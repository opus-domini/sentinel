...
`,
		...
		{name: "zero port", content: "[server]\nport = 0\n", wantErr: "server.port"},
		{name: "zero max concurrent", content: "[runbooks]\nmax_concurrent = 0\n", wantErr: "runbooks.max_concurrent"},
		{name: "zero tick interval", content: "[watchtower]\ntick_interval = \"0s\"\n", wantErr: "watchtower.tick_interval"},
		{name: "zero capture lines", content: "[watchtower]\ncapture_lines = 0\n", wantErr: "watchtower.capture_lines"},
		{name: "zero capture timeout", content: "[watchtower]\ncapture_timeout = \"0s\"\n", wantErr: "watchtower.capture_timeout"},
		{name: "zero journal rows", content: "[watchtower]\njournal_rows = 0\n", wantErr: "watchtower.journal_rows"},
