...
func TestSessionLauncherHandlers(t *testing.T) {
	...
	t.Run("create list update delete launcher", testSessionLauncherCreateListUpdateDelete)
	t.Run("reorder launchers", testSessionLauncherReorder)
	t.Run("launch creates session and records usage", testSessionLauncherLaunchCreatesSessionAndRecordsUsage)
	t.Run("launch existing session creates numbered session", testSessionLauncherLaunchExistingSessionCreatesNumberedSession)
	t.Run("killing launched session keeps launcher", testSessionLauncherKillingLaunchedSessionKeepsLauncher)
}
...
func testSessionLauncherLaunchCreatesSessionAndRecordsUsage(t *testing.T) {
	t.Parallel()
...
func testSessionLauncherLaunchExistingSessionCreatesNumberedSession(t *testing.T) {
	t.Parallel()
