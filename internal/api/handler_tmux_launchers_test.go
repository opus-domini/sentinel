...
func TestTmuxLauncherHandlers(t *testing.T) {
	...
	t.Run("create list update delete launcher", testTmuxLauncherCreateListUpdateDelete)
	t.Run("create validates icon and cwd", testTmuxLauncherCreateValidatesIconAndCWD)
	t.Run("create accepts blank command", testTmuxLauncherCreateAcceptsBlankCommand)
	t.Run("create returns invalid request for missing fixed cwd", testTmuxLauncherCreateRequiresFixedCWD)
	t.Run("reorder launchers", testTmuxLauncherReorder)
...
func testTmuxLauncherLaunchCreatesWindowAndSendsCommand(t *testing.T) {
	t.Parallel()
...
func testTmuxLauncherLaunchSkipsBlankCommand(t *testing.T) {
	t.Parallel()
...
func testTmuxLauncherLaunchFixedUserWrapsCommand(t *testing.T) {
	const sessionName = "dev"
