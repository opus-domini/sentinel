...
func (h *Handler) registerTmuxRoutes(mux *http.ServeMux) {
	h.registerRoutes(mux, []routeBinding{
		...
		{pattern: "GET /api/tmux/session-launchers", handler: h.listSessionLaunchers},
		{pattern: "POST /api/tmux/session-launchers", handler: h.createSessionLauncher},
		{pattern: "PATCH /api/tmux/session-launchers/order", handler: h.reorderSessionLaunchers},
		{pattern: "PATCH /api/tmux/session-launchers/{launcher}", handler: h.updateSessionLauncher},
		{pattern: "DELETE /api/tmux/session-launchers/{launcher}", handler: h.deleteSessionLauncher},
		{pattern: "POST /api/tmux/session-launchers/{launcher}/launch", handler: h.launchSessionLauncher},
